  ...
  fetchStudents: async (
    ...
    try {
      ...
      const response = await axios.get(
        `${baseURL}/students/students/?page=${page}&search=${trimmedQuery}&payment_status=${selectedValue}&page_size=30&category=${category}&is_challenge_user=${is_challenge_user}`,
        {
          headers: {
