//this is for the any click of project
...
const EditProject = ({
  ...
  useEffect(() => {
    ...
    if (project?.[0]?.project_url) {
      setProjectLink(project?.[0]?.project_url);
    }
    if (project?.[0]?.project_hint) {
      setDescription(project?.[0]?.project_hint);
    }
  }, []);
