...
const LandingCard = ({ image, headText, bodyText }: Componentprops) => {
  return (
    <div className="md:w-[416px] w-auto h-[284px] flex flex-col justify-center p-5 bg-white shadow-md rounded-[16px]">
      <Image src={image} alt="img" className="md:w-auto w-5 h-5 md:h-auto" />
      <div>
